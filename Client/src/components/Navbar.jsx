...
const Navbar = () => {
  ...
  return (
    <>
      {showLogoutToast && (
        <div className="fixed top-8 right-8 z-[9999] px-6 py-4 rounded-lg shadow-lg flex items-center space-x-3 transition-all duration-300 bg-red-500 text-white" role="alert">
          <span className="font-semibold">You have been logged out successfully.</span>
        </div>
      )}
